...
--	bag names - used to name the empty slots in the status frame (and LDB)
	...
	L["STATUS_NAME_PROJECTILE_ARROW"] = "Arw"
	L["STATUS_NAME_PROJECTILE_BULLET"] = "Blt"
	L["STATUS_NAME_SOULSHARD"] = "Shrd"
...
--	configuration options > control
	...
	L["CONFIG_CONTROL_REPOSITION"] = "Reposition"
	L["CONFIG_CONTROL_REPOSITION_TEXT"] = "Repositions the %1$s window back onto the screen" -- %1$s = location name
...
--	libdatabroker
	...
	L["LDB_COMPANION_RESTRICTED"] = "|cffe55029\nRequires a reagent to summon, is restricted to a specific location(s) or has some other restriction.\n\nYou may or may not meet the requirements to summon this companion|r"
